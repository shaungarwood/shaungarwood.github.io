...
description: "Building an automated system provisioning kit inspired by Mr. Robot — because nobody has time to set up environments from scratch."
image: "../assets/mr-robots-bootstraps.png"
createdAt: 01-13-2020
draft: false
tags:
  - ansible
  - bash
...
[shaungarwood.com/bs.sh](https://shaungarwood.com/bs.sh)
...
Full repo: [https://github.com/shaungarwood/my_bootstraps](https://github.com/shaungarwood/my_bootstraps)
...
[Here's an asciinema recording](https://asciinema.org/a/oOVnonDr00420VksGn99HN8H9) if you want to see it in action.
