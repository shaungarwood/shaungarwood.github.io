...
description: "A top-to-bottom proof-of-concept for getting Docker logs flowing into a Splunk instance via the HTTP Event Collector."
image: "../assets/splunk-docker-logging-poc.png"
